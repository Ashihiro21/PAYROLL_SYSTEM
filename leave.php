        ...
        <div class="jumbotron bg-light shadow border border-secondary">
            ...
            <div class="card bg-light" style="border-color: transparent;">
                ...
                if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                    ...
                    $result_count = mysqli_query($connection,"SELECT COUNT(*) As total_records FROM leaves");
                    $total_records = mysqli_fetch_array($result_count);
                    $total_records = $total_records['total_records'];
                    $total_no_of_pages = ceil($total_records / $total_records_per_page);
                    $second_last = $total_no_of_pages - 1; // total page minus 1
 
                    $query = "SELECT * FROM leaves ORDER BY id DESC LIMIT $offset, $total_records_per_page";
...
if ($total_no_of_pages <= 10) {  	 
    for ($counter = 1; $counter <= $total_no_of_pages; $counter++) {
        if ($counter == $page_no) {
            ...
            echo "<li class='page-item'><a class='page-link' href='nav.php?page=leave.php&page_no=$counter'>$counter</a></li>";
        }
    }
    ...
    if ($page_no <= 4) {			
        ...
        echo "<li class='page-item'><a class='page-link' href='nav.php?page=leave.php&page_no=$second_last'>$second_last</a></li>";
        echo "<li class='page-item'><a class='page-link' href='nav.php?page=leave.php&page_no=$total_no_of_pages'>$total_no_of_pages</a></li>";
    } elseif ($page_no > 4 && $page_no < $total_no_of_pages - 4) {		 
        echo "<li class='page-item'><a class='page-link' href='nav.php?page=leave.php&page_no=1'>1</a></li>";
        echo "<li class='page-item'><a class='page-link' href='nav.php?page=leave.php&page_no=2'>2</a></li>";
        echo "<li class='page-item'><a class='page-link'>...</a></li>";
