...
// Loop through database query result and add data rows
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        // $html .= '<tr><td style="font-size: 18px;">Net Pay:</td><td style="font-size: 18px;">' . number_format($net < 0 ? 0 : $net, 2) . '</td></tr>
