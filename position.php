            ...
            <div class="card bg-light" style="border-color: transparent;">
                <div class="card-body">
                  ...
                  if (isset($_GET['page_no']) && $_GET['page_no']!="") {
                      ...
                      $result_count = mysqli_query($connection,"SELECT COUNT(*) As total_records FROM position");
                      $total_records = mysqli_fetch_array($result_count);
                      $total_records = $total_records['total_records'];
                      $total_no_of_pages = ceil($total_records / $total_records_per_page);
                      $second_last = $total_no_of_pages - 1; // total page minus 1
   
                      $query = "SELECT * FROM position ORDER BY id DESC LIMIT $offset, $total_records_per_page";
