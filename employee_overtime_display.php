...
<!-- First Page -->
<?php // if($page_no > 1){ echo "<li><a href='employee_main.php?page=employee_overtime_display.php&page_no=1'>First Page</a></li>"; } ?>

<!-- Previous Page -->
<li class="page-item <?php if($page_no <= 1) echo 'disabled'; ?>">
    <a class="page-link" <?php if($page_no > 1) echo "href='employee_main.php?page=employee_overtime_display.php&page_no=$previous_page'"; ?>>Previous</a>
</li>
...
if ($total_no_of_pages <= 10) {  	 
    for ($counter = 1; $counter <= $total_no_of_pages; $counter++) {
        if ($counter == $page_no) {
            ...
            echo "<li class='page-item'><a class='page-link' href='employee_main.php?page=employee_overtime_display.php&page_no=$counter'>$counter</a></li>";
        }
    }
    ...
    if ($page_no <= 4) {			
        ...
        echo "<li class='page-item'><a class='page-link' href='employee_main.php?page=employee_overtime_display.php&page_no=$second_last'>$second_last</a></li>";
        echo "<li class='page-item'><a class='page-link' href='employee_main.php?page=employee_overtime_display.php&page_no=$total_no_of_pages'>$total_no_of_pages</a></li>";
    } elseif ($page_no > 4 && $page_no < $total_no_of_pages - 4) {		 
        echo "<li class='page-item'><a class='page-link' href='employee_main.php?page=employee_overtime_display.php&page_no=1'>1</a></li>";
        echo "<li class='page-item'><a class='page-link' href='employee_main.php?page=employee_overtime_display.php&page_no=2'>2</a></li>";
        echo "<li class='page-item'><a class='page-link'>...</a></li>";
